...
import dev.junior.ccos.web.rest.errors.EmailAlreadyUsedException;
import dev.junior.ccos.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link dev.junior.ccos.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<AdminUserDTO> getUserByEmail(@PathVariable("email") String email) {
